(function () {
  ...
  /** Nav Start */
  let nav_closed = document.querySelector(".nav-closed");
  let nav_opened = document.querySelector(".nav-opened");
  ...
  nav_closed.addEventListener("click", start_transition.play);
  /** Nav End */
})();
